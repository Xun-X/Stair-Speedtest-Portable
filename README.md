...
## 關於殺毒軟體的報毒 T_T
為了證明本程式沒有病毒作者就給電腦裝上了殺毒軟體試了試，不試不知道詫異的發現居然說是木馬程式，可能是因為運行要釋放包含SSR/v2ray/web測速環境以及聯網檢測版本等行為讓殺毒軟體不得不懷疑這是病毒程式，作者在這裏還是那句話吧，覺得不安全那麽請關閉這個頁面（當然大陸同胞們越墻可能也不會裝類似360全家桶那種極度敏感並且惡心的殺毒軟體），但良心告訴我，這件事還是要事先聲明，360安全衛士對本程式提醒報毒，不放心就不要用了！
